...
Líkönin þrjú að heild eru hér að neðan, þar sem $y$ stendur fyrir líkurnar á því að fá rétt svar og $\text{studentId}_n$ er "mixed logistic effect" í þessu tilviki.
...
Það getur verið sterkur áhugi að stilla upp sömu töflu aftur, nema í tilviki með bara upp að 100 spurningum svarað í einu og svo 50 spurningum svarað í einu. \@ref(tab:shorter-table-100)
...
Til að fá betri sjónarhorn á hlutföllin, þá gæti verið gott að bæta við línurnar hjá hlutföllunum við mynd \@ref(fig:meanbyhlutfall50), semsagt hafa línuna fyrir tilvikið þegar nemandinn hefur ekki séð rétta svarið áður með línurnar hjá hlutfall röngu svarmöguleikana fram að þessu hliðiná. Dökkbláa línan er upprunalega línan frá mynd \@ref(fig:meanbyhlutfall50), á meðan hinar línurnar eru fyrir sitthvora hlutfalls hópana.
...
#### hér er nokkuð sem þarf að fínpússa

Gott er að skoða calibration plot fyrir gögninn með:
...
Svo er líka gott að skoða dreifingu hjá "prediction" líkananna með histogrammi:

```{r optimismpicture, echo=FALSE, fig.align='center', fig.cap="Histogram fyrir predictionin fyrir líköninn þrjú", fig.pos='H', out.width='100%'}
